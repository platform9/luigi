...
import (
	...
	"github.com/platform9/luigi/yoshi/pkg/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5513afe8.k8s.pf9.io",
	...
	if err = (&controllers.NetworkWizardReconciler{
		...
		Log:    ctrl.Log.WithName("controller").WithName("NetworkWizard"),
	...
	if err = (&controllers.VMReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		Log:    ctrl.Log.WithName("controller").WithName("VirtualMachine"),
	}).SetupWithManager(mgr); err != nil {
