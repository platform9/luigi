...
func (in *KubePlugins) DeepCopyInto(out *KubePlugins) {
	*out = *in
	if in.Multus != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubePlugins.
func (in *KubePlugins) DeepCopy() *KubePlugins {
	if in == nil {
		return nil
	}
	out := new(KubePlugins)
...
func (in *NetworkPluginsSpec) DeepCopyInto(out *NetworkPluginsSpec) {
	*out = *in
	if in.KubePlugins != nil {
		in, out := &in.KubePlugins, &out.KubePlugins
		*out = new(KubePlugins)
		(*in).DeepCopyInto(*out)
	}
}
