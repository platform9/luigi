...
type HostStateSpec struct {
	...
	InterfaceStatus []*InterfaceStatus `yaml:"interfaceStatus,omitempty"`
	Sysctl          []string          `yaml:"sysctlConfig,omitempty"`
}

type InterfaceStatus struct {
	PfName       string       `yaml:"pfName,omitempty"`
	PciAddr      string       `yaml:"pciAddr,omitempty"`
	VendorId     string          `yaml:"vendorId,omitempty"`
	DeviceId     string          `yaml:"deviceId,omitempty"`
    MacAddr      string       `yaml:"macAddr,omitempty"`
	MTU          int          `yaml:"mtu,omitempty"`
	PfDriver     string       `yaml:"pfDriver,omitempty"`
	SriovEnabled bool         `yaml:"sriovEnabled"`
	SriovStatus  *SriovStatus `yaml:"currentSriovConfig,omitempty"`
}

type SriovStatus struct {
	TotalVfs int    `yaml:"totalVfs,omitempty"`
	NumVfs   int    `yaml:"numVfs,omitempty"`
    Vfs []*VfInfo `yaml:"vfs,omitempty"`
}

type VfInfo struct {
	ID        int `yaml:"id"`
	VfDriver string `yaml:vfDriver"`
    PciAddr string `yaml:pciAddr"`
	Mac       string `yaml:"mac"`
	Vlan      int `yaml:"vlan"`
	Qos       int `yaml:"qos"`
	Spoofchk  bool `yaml:"spoofchk"`
    Trust     bool `yaml:"trust"`
}

type HostState struct {
	Spec   HostStateSpec   `yaml:"spec,omitempty"`
}
*/
