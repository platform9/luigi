...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtPlugins) DeepCopyInto(out *VirtPlugins) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtPlugins.
func (in *VirtPlugins) DeepCopy() *VirtPlugins {
	if in == nil {
		return nil
	}
	out := new(VirtPlugins)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VirtPlugins) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtPluginsList) DeepCopyInto(out *VirtPluginsList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]VirtPlugins, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtPluginsList.
func (in *VirtPluginsList) DeepCopy() *VirtPluginsList {
	if in == nil {
		return nil
	}
	out := new(VirtPluginsList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VirtPluginsList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtPluginsSpec) DeepCopyInto(out *VirtPluginsSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtPluginsSpec.
func (in *VirtPluginsSpec) DeepCopy() *VirtPluginsSpec {
	if in == nil {
		return nil
	}
	out := new(VirtPluginsSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtPluginsStatus) DeepCopyInto(out *VirtPluginsStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtPluginsStatus.
func (in *VirtPluginsStatus) DeepCopy() *VirtPluginsStatus {
	if in == nil {
		return nil
	}
	out := new(VirtPluginsStatus)
	in.DeepCopyInto(out)
	return out
}
