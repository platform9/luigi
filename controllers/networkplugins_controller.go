...
const (
	...
	MultusImage             = "quay.io/platform9/multus:v3.7.2-pmk-3440935"
	WhereaboutsImage        = "quay.io/platform9/whereabouts:v0.6-pmk-3427514"
	SriovCniImage           = "quay.io/platform9/sriov-cni:v2.6.2-pmk-3452370"
	SriovDpImage            = "quay.io/platform9/sriov-network-device-plugin:v3.3.2-pmk-3452375"
	OvsImage                = "quay.io/platform9/openvswitch:v0.5.7-14"
	...
	DhcpControllerImage     = "quay.io/platform9/pf9-dhcp-controller:v1.1"
	...
	NfdImage                = "quay.io/platform9/node-feature-discovery:v0.11.3-pmk-3426814"
